...
@synthesize sendSearchByUserAlpha       = _sndSearchAlpha;
...
- (id)init
{
	...
	// 送信ウィンドウ
	[mutableDic setObject:[NSNumber numberWithBool:NO] forKey:SNDSEARCH_USER];
	[mutableDic setObject:[NSNumber numberWithBool:NO] forKey:SNDSEARCH_GROUP];
